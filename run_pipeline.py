...
from src.pollinations_image_generator import MultiAPIImageGenerator
...
def run_complete_pipeline():
    ...
    try:
        ...
        # 2. Generate images from scripts (using Pollinations.ai)
        logger.info("🖼️ Generating images from scripts...")
        from src.pollinations_image_generator import PollinationsImageGenerator
        img_generator = MultiAPIImageGenerator()
        
        # Generate podcast images (25 images)
        logger.info("🎨 Generating podcast images (25)...")
        podcast_images = img_generator.generate_images_from_script(topic, podcast_script, "podcast", target_count=25)
        
        # Generate shorts images (10 images)
        logger.info("🎨 Generating shorts images (10)...")
        shorts_images = img_generator.generate_images_from_script(topic, shorts_script, "shorts", target_count=10)
