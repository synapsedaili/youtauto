...
# Shorts ve podcast başarı durumları
shorts_success = False
podcast_success = False

def run_shorts_pipeline():
    global shorts_success
...
if __name__ == "__main__":
    ...
    # İkisi de ayrı ayrı çalıştırılıyorsa, sidea.txt güncellenmez
    # (Çünkü ikisinin de tamamlandığından emin olunamaz)
    #	sidea.txt güncellemesi MANUEL Olarak yapılmalıdır
