...
from src.secure_image_generator import generate_daily_images
...
def run_complete_pipeline():
    ...
    try:
        ...
        # 2. Generate images from scripts
        logger.info("🖼️ Generating images from scripts...")
        from src.secure_image_generator import SecureImageGenerator
        img_generator = SecureImageGenerator()
