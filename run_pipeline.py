...
def run_shorts_pipeline():
    ...
    try:
        Config.ensure_directories()  # Dizinleri garanti et
        ...
        with tempfile.TemporaryDirectory(dir=str(Config.TEMP_DIR)) as temp_dir:
            ...
            # Videoyu oluştur (67 saniye maksimum)
            video_path = temp_path / "shorts_video.mp4"
            logger.info("🎥 Video render ediliyor (67 saniye sınırı)...")
            create_shorts_video(str(audio_path), script, str(video_path), max_duration=67)
