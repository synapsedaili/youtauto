...
"""
Fast Video Generator Module
===========================

Bu modül hızlı testler için src/image klasöründen görsel alır ve video üretir.
YouTube upload kaldırıldı (client_secret.json yok).
"""
...
def create_and_save_video(script, output_filename, is_shorts=True):
    ...
    print(f"✅ Video kaydedildi: {final_output_path}")
    
    # Geçici dosyaları temizle
    shutil.rmtree(temp_dir)
    
    print(f"🎉 {('Shorts' if is_shorts else 'Podcast')} tamamlandı! Dosya: {final_output_path}")
