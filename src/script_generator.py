...
BEGINNING:"""
    ...
    def _generate_podcast_in_chunks(self, topic: str, generate_func) -> str:
        ...
        for i in range(3):
            ...
            try:
                chunk = generate_func(topic, "podcast", custom_prompt=prompt)
                if not chunk:
                    break
    ...
    def _generate_with_qwen(self, topic: str, mode: str, custom_prompt=None) -> str:
        return self._generate_with_ollama_model(topic, mode, "qwen2", custom_prompt)
    
    def _generate_with_deepseek(self, topic: str, mode: str, custom_prompt=None) -> str:
        return self._generate_with_ollama_model(topic, mode, "deepseek-r1", custom_prompt)
