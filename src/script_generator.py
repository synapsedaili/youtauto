...
SCRIPT:"""
    ...
    def _generate_with_qwen(self, topic: str, mode: str, custom_prompt=None, timeout=120) -> str:
        return self._generate_with_ollama_model(topic, mode, "qwen2:0.5b", custom_prompt, timeout)

    def _generate_with_deepseek(self, topic: str, mode: str, custom_prompt=None, timeout=120) -> str:
        return self._generate_with_ollama_model(topic, mode, "deepseek-r1:1.3b", custom_prompt, timeout)

    def _generate_with_ollama_fallback(self, topic: str, mode: str, custom_prompt=None, timeout=120) -> str:
        return self._generate_with_ollama_model(topic, mode, "llama3.2:1b", custom_prompt, timeout)
