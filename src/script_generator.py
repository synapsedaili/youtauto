...
Rules:
- Write exactly 1150 characters
- First 3 seconds: SHOCKING HOOK (verified fact)
- Include 2 curiosity questions
- Mid-video: "For the full story, listen to today's podcast!"
- End: "Like, comment, subscribe for more Cold War mysteries!"
- Sentences: max 8 words, simple English
- No technical terms like "Opening a shot" or prompts
...
Rules:
- Write Chapter 1-4 of a 7000-word podcast
- Each chapter: 600-800 words
...
Rules:
- Continue with Chapter 5-8 of the podcast
...
Rules:
- Complete with Chapter 9-13 of the podcast
- Each chapter: 900-1100 words  
