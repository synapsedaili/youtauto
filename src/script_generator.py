...
def generate_script(topic: str, mode: str = "shorts") -> str:
    ...
    if mode == "shorts":
        ...
        max_chars = Config.PODCAST_CHAR_LIMIT  # 15 kat artırıldı ✅
    ...
    try:
        ...
        if response.status_code != 200:
            ...
            # Fallback metin
            if mode == "shorts":
                fallback = "Welcome to Synapse Daily! Today we explore Cold War tech mysteries. What forgotten future should we uncover next? Don't forget to like, comment, and subscribe!"
            else:
                fallback = "Welcome to Synapse Daily Podcast. Today we dive deep into Cold War oddities and unbuilt utopias. If you enjoyed this, don't forget to like, comment, and subscribe!"
