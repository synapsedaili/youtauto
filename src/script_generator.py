...
class AIScriptGenerator:
    ...
    def _generate_with_phi3(self, topic: str, mode: str, custom_prompt=None, timeout=120) -> str:
        return self._generate_with_ollama_model(topic, mode, "phi3:mini", custom_prompt, timeout)
...
[Engineering challenges, political context...]

Chapter 4: [Legacy & Modern Relevance]
[Why this matters today, final reflections...]
...
SCRIPT:"""
    ...
    def _generate_podcast_in_chunks(self, topic: str, generate_func) -> str:
        ...
        for i in range(3):
            logger.info(f"Checking chapter {i+1}/3...")
...
If you enjoyed this dive into lost futures, don't forget to like, comment your thoughts below, and subscribe for more fascinating stories!
""".strip().ljust(45000)
