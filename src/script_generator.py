...
Requirements:
- Write EXACTLY 700 words for this chapter
...
- Count your words: exactly 700 words required
...
Chapter {chapter_num} Content:"""
    ...
    def _generate_podcast_in_13_chapters(self, topic: str, generate_func: Callable) -> str:
        """Podcast metnini 13 chapter'da üretir (her chapter 700 words)."""
        full_script = ""
        ...
        for chapter_num in range(1, 14):
            ...
            try:
                ...
                logger.info(f"Chapter {chapter_num} produced {word_count} words (target: 700)")
                
                if word_count < 500:
                    # 500 altıysa genişlet
                    logger.info(f"🔄 Extending Chapter {chapter_num} ({word_count}/700)")
